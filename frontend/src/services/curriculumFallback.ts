...
const CURRICULUM_STORE: Record<string, Record<number, LevelData>> = {
  ...
  ja: {
      ...
      exercises: [
        {
          id: 4201,
          type: 'match_pairs',
          prompt: 'Tap the matching Japanese pairs',
          prompt_translation: 'Connect Japanese and English words',
          options: {
            left: ['こんにちは', 'ありがとう', 'さようなら', 'みず'],
        ...
        },
        {
          id: 4202,
          type: 'multiple_choice',
          prompt: "How do you say 'Excuse me' in Japanese?",
          prompt_translation: 'Select polite phrase',
          audio_text: 'すみません',
          options: [
            { text: 'すみません (Sumimasen)', translation: 'Excuse me / Sorry' },
            { text: 'はい (Hai)', translation: 'Yes' },
            { text: 'いいえ (Iie)', translation: 'No' },
          ],
          correct_answer: 'すみません (Sumimasen)',
        },
        {
          id: 4203,
          type: 'word_bank',
          prompt: "Translate 'Water please'",
          prompt_translation: 'みず を ください (Mizu o kudasai)',
          audio_text: 'みずをください',
          options: ['Water', 'please', 'tea', 'thank', 'you'],
          correct_answer: 'Water please',
        },
        {
          id: 4204,
          type: 'fill_in_blank',
          prompt: 'Fill in the blank for tea: お____ (Ocha)',
          prompt_translation: 'Type or choose the missing syllable',
          audio_text: 'おちゃ',
          options: ['ちゃ', 'みず', 'はい'],
          correct_answer: 'ちゃ',
        },
      ...
      exercises: [
        {
          ...
          options: [
            { text: 'はい (Hai)', translation: 'Yes' },
            { text: 'いいえ (Iie)', translation: 'No' },
            { text: 'どうも (Doumo)', translation: 'Thanks' },
          ],
        ...
        },
        {
          ...
          prompt_translation: 'これ は みず です (Kore wa mizu desu)',
          audio_text: 'これはみずです',
          options: ['This', 'is', 'water', 'tea', 'delicious'],
    ...
    5: {
      ...
      skill_title: 'Food & Dining',
      xp_reward: 15,
      exercises: [
        {
          id: 4501,
          type: 'multiple_choice',
          prompt: "What does 'ごはん (Gohan)' mean?",
          prompt_translation: 'Select food item',
          audio_text: 'ごはん',
          options: [
            { text: 'rice / meal', translation: 'ごはん' },
            { text: 'water', translation: 'みず' },
            { text: 'tea', translation: 'おちゃ' },
          ],
        ...
        },
        {
          id: 4502,
          type: 'word_bank',
          prompt: "Translate 'Green tea please'",
          prompt_translation: 'おちゃ を ください (Ocha o kudasai)',
          audio_text: 'おちゃをください',
          options: ['Green', 'tea', 'please', 'water', 'rice'],
          correct_answer: 'Green tea please',
        },
        {
          id: 4503,
          type: 'match_pairs',
          prompt: 'Match Japanese food and drink vocabulary',
          prompt_translation: 'Pair vocabulary',
          options: {
            left: ['おちゃ', 'ごはん', 'みず', 'すし'],
            right: ['tea', 'rice', 'water', 'sushi'],
          },
          correct_answer: {
            'おちゃ': 'tea',
            'ごはん': 'rice',
    ...
    6: {
      ...
      skill_title: 'Unit 1 Mastery',
      xp_reward: 25,
      exercises: [
        {
          id: 4601,
          type: 'multiple_choice',
          prompt: "What does 'おいしい (Oishii)' mean?",
          prompt_translation: 'Select description',
          audio_text: 'おいしい',
          options: [
            { text: 'delicious', translation: 'おいしい' },
            { text: 'hot', translation: 'あつい' },
            { text: 'cold', translation: 'つめたい' },
          ],
        ...
        },
        {
          id: 4602,
          type: 'word_bank',
          prompt: "Translate 'This is delicious'",
          prompt_translation: 'これ は おいしい です (Kore wa oishii desu)',
          audio_text: 'これはおいしいです',
          options: ['This', 'is', 'delicious', 'water', 'tea', 'very'],
        ...
        },
        {
          ...
          correct_answer: 'さようなら (Sayounara)',
        },
      ],
    },
  },
